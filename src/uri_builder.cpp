...
uri_builder &uri_builder::append_path(const my_string_t &path, bool is_encode)
{
...
uri_builder &uri_builder::append_query(const my_string_t &query, bool is_encode)
{
    if (query.empty())
    {
        return *this;
...
my_string_t uri_builder::to_string() const
{
