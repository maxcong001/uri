...
class uri_builder
{
  public:
    ...
    my_string_t print_string(const Source &val)
    {
        my_ostringstream_t oss;
    ...
    inline const my_string_t& print_string(const my_string_t &val)
    {
        return val;
    }
    ...
    const  my_string_t &scheme() const { return m_uri.m_scheme; }

    /// <summary>
    /// Get the user information component of the URI as an encoded string.
    /// </summary>
    /// <returns>The URI user information as a string.</returns>
    const  my_string_t &user_info() const { return m_uri.m_user_info; }

    /// <summary>
    /// Get the host component of the URI as an encoded string.
    /// </summary>
    /// <returns>The URI host as a string.</returns>
    const  my_string_t &host() const { return m_uri.m_host; }
    ...
    const  my_string_t &path() const { return m_uri.m_path; }

    /// <summary>
    /// Get the query component of the URI as an encoded string.
    /// </summary>
    /// <returns>The URI query as a string.</returns>
    const  my_string_t &query() const { return m_uri.m_query; }

    /// <summary>
    /// Get the fragment component of the URI as an encoded string.
    /// </summary>
    /// <returns>The URI fragment as a string.</returns>
    const  my_string_t &fragment() const { return m_uri.m_fragment; }
    ...
    uri_builder &set_scheme(const  my_string_t &scheme)
    {
    ...
    /// <returns>A reference to this <c>uri_builder</c> to support chaining.</returns>
    uri_builder &set_user_info(const  my_string_t &user_info, bool do_encoding = false)
    {
    ...
    /// <param name="do_encoding">Specify whether to apply URI encoding to the given string.</param>
    /// <returns>A reference to this <c>uri_builder</c> to support chaining.</returns>
    uri_builder &set_host(const  my_string_t &host, bool do_encoding = false)
    {
    ...
    uri_builder &set_port(const  my_string_t &port)
    {
        my_istringstream_t portStream(port);
        int port_tmp;
        portStream >> port_tmp;
    ...
    /// <param name="do_encoding">Specify whether to apply URI encoding to the given string.</param>
    /// <returns>A reference to this <c>uri_builder</c> to support chaining.</returns>
    uri_builder &set_path(const  my_string_t &path, bool do_encoding = false)
    {
    ...
    /// <returns>A reference to this <c>uri_builder</c> to support chaining.</returns>
    uri_builder &set_query(const  my_string_t &query, bool do_encoding = false)
    {
    ...
    /// <param name="do_encoding">Specify whether to apply URI encoding to the given string.</param>
    /// <returns>A reference to this <c>uri_builder</c> to support chaining.</returns>
    uri_builder &set_fragment(const  my_string_t &fragment, bool do_encoding = false)
    {
    ...
    _ASYNCRTIMP uri_builder &append_path(const  my_string_t &path, bool do_encoding = false);
    ...
    /// <param name="do_encoding">Specify whether to apply URI encoding to the given string.</param>
    /// <returns>A reference to this uri_builder to support chaining.</returns>
    _ASYNCRTIMP uri_builder &append_query(const  my_string_t &query, bool do_encoding = false);
    ...
    /// <returns>A reference to this uri_builder to support chaining.</returns>
    template <typename T>
    uri_builder &append_query(const  my_string_t &name, const T &value, bool do_encoding = true)
    {
        auto encodedName = name;
        auto encodedValue = print_string(value);
    ...
    _ASYNCRTIMP  my_string_t to_string() const;
