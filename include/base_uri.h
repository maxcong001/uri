...
*
* For the latest on this and related APIs, please see: https://github.com/maxcong001/uri
*
* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
****/
...
#include <functional>
typedef char char_t;
typedef std::string my_string_t;
typedef std::istringstream my_istringstream_t;
typedef std::ostringstream my_ostringstream_t;
...
struct uri_components
{
    ...
    uri_components(const uri_components &other) : m_scheme(other.m_scheme),
                                                  m_host(other.m_host),
    ...
    _ASYNCRTIMP my_string_t join();

    my_string_t m_scheme;
    my_string_t m_host;
    my_string_t m_user_info;
    my_string_t m_path;
    my_string_t m_query;
    my_string_t m_fragment;
    int m_port;
};
}
...
class uri
{
  public:
    ...
    _ASYNCRTIMP static my_string_t __cdecl encode_uri(const my_string_t &raw, uri::components::component = components::full_uri);
    ...
    /// <returns>The encoded string.</returns>
    _ASYNCRTIMP static my_string_t __cdecl encode_data_string(const my_string_t &utf8data);
    ...
    _ASYNCRTIMP static my_string_t __cdecl decode(const my_string_t &encoded);

    /// <summary>
    /// Splits a path into its hierarchical components.
    /// </summary>
    /// <param name="path">The path as a string</param>
    /// <returns>A <c>std::vector&lt;my_string_t&gt;</c> containing the segments in the path.</returns>
    _ASYNCRTIMP static std::vector<my_string_t> __cdecl split_path(const my_string_t &path);

    /// <summary>
    /// Splits a query into its key-value components.
    /// </summary>
    /// <param name="query">The query string</param>
    /// <returns>A <c>std::map&lt;my_string_t, my_string_t&gt;</c> containing the key-value components of the query.</returns>
    _ASYNCRTIMP static std::map<my_string_t, my_string_t> __cdecl split_query(const my_string_t &query);
    ...
    _ASYNCRTIMP static bool __cdecl validate(const my_string_t &uri_string);
    ...
    _ASYNCRTIMP uri(const char_t *uri_string);
    ...
    _ASYNCRTIMP uri(const my_string_t &uri_string);
    ...
    /// Move constructor.
    /// </summary>
    uri(uri &&other) CPPREST_NOEXCEPT : m_uri(std::move(other.m_uri)),
    ...
    const my_string_t &scheme() const { return m_components.m_scheme; }

    /// <summary>
    /// Get the user information component of the URI as an encoded string.
    /// </summary>
    /// <returns>The URI user information as a string.</returns>
    const my_string_t &user_info() const { return m_components.m_user_info; }

    /// <summary>
    /// Get the host component of the URI as an encoded string.
    /// </summary>
    /// <returns>The URI host as a string.</returns>
    const my_string_t &host() const { return m_components.m_host; }
    ...
    const my_string_t &path() const { return m_components.m_path; }

    /// <summary>
    /// Get the query component of the URI as an encoded string.
    /// </summary>
    /// <returns>The URI query as a string.</returns>
    const my_string_t &query() const { return m_components.m_query; }

    /// <summary>
    /// Get the fragment component of the URI as an encoded string.
    /// </summary>
    /// <returns>The URI fragment as a string.</returns>
    const my_string_t &fragment() const { return m_components.m_fragment; }
  ...
  private:
    ...
    _ASYNCRTIMP static my_string_t __cdecl encode_impl(const my_string_t &raw, const std::function<bool __cdecl(int)> &should_encode);
